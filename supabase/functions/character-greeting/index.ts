...
const CHARACTERS = {
  ...
  'teacher': {
    name: 'Учитель',
    role: 'Школа AI',
    personality: 'мудрый, терпеливый, мотивирующий',
    topics: [
      'как использовать ИИ в жизни',
      'промпт-инженерия',
      'нейросети для заработка',
      'автоматизация с ChatGPT',
      'курсы по AI',
      'практические задания'
    ],
    callToAction: 'Нажми — начнём урок и получишь XP!'
  }
}
...
Сгенерируй ОДНУ фразу:`
  ...
  if (!response.ok) {
    ...
    const fallbacks: Record<string, string[]> = {
      ...
      'teacher': [
        'Новый урок по ИИ ждёт! 📚 Заходи',
        'Прокачай навыки нейросетей! 🎓 Нажми',
        'XP за знания! 🏆 Начнём урок?'
      ]
    }
